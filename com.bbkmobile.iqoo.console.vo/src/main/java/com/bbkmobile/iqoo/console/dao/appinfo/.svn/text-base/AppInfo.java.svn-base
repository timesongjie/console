...
//	private Integer discount;
	...
	private String safe;                      //格式为三位  比如000 位置对应 i管家/360/QQ     "0":"未检测","1":"安全","2":"不安全"
	...
	public AppInfo(Long id, Developer developer, String appCnName,
			String appEnName, String appVersion, String appIcon, String appApk,
			Integer apkSize, String appVersionCode, String appPackage,
			float avg_comment, Integer commentCount, Integer downloadCount,
			String patchs, Short tag,char official) {
		super();
		this.id = id;
