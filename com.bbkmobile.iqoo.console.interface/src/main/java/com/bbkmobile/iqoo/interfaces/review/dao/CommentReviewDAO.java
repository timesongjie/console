...
public interface CommentReviewDAO {
    boolean isCommented(final RequestParameter requestParameter, final String target) throws Exception;
    CommentGrade getCommentGrade(Long app_id) throws Exception;
//    
    List<AppComment> findAppCommentList(Long app_id, int apps_per_page, int page_index) throws Exception; //add by haiyan
    int countAppCommentList(final Long app_id) throws Exception;
//    
    List<BaiduAppComment> findBaiduAppCommentList(final Long app_id, final int apps_per_page, final int page_index) throws Exception;
...
//    int countAppCommentRecords1(final AppComment appComment) throws Exception;
//    
//    List<AppComment> getAppCommentList(int start, final AppComment appComment) throws Exception; 
//    List<AppComment> getAppCommentList1(final int start, final AppComment appComment) throws Exception;
//   
...
//    
//    
//    List<CommentReviewRecords> findCommentReviewRecord(AppComment appComment) throws Exception;
//
//    AppComment findAppCommentById(Long app_id) throws Exception;
//
//    boolean updateForCommentReview(CommentReviewRecords review,Integer adminUserId) throws Exception;
//
//    boolean updateForCommentReview(Long[] ids, CommentReviewRecords review, Integer adminUserId) throws Exception;
//    
//    boolean saveComments(AppInfo appInfo, AppComment appComment,String [] strArray) throws Exception;
